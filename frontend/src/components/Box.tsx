...
const Box = (props: any) => {
  return (
    <div className="relative flex flex-col my-20 bg-transparent text-white shadow-sm border border-slate-600 border-y-2 rounded-2xl w-2/3 mx-auto h-auto p-6">
